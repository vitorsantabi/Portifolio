    ...
    <section className="min-h-[calc(100vh-80px)] section-padding bg-gray-50 dark:bg-gray-800 transition-colors duration-300">
      <div className="container-max">
        ...
        <article className="max-w-4xl mx-auto animate-fade-in">
          <div className="rounded-2xl overflow-hidden shadow-2xl bg-gray-200 dark:bg-gray-700 mb-8 ring-1 ring-gray-200 dark:ring-gray-600">
            <img
              src={project.image}
              alt=""
              className="w-full h-auto max-h-[min(420px,50vh)] object-cover object-top"
            />
          </div>
